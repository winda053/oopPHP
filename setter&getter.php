...
class produk{
    //Property
//saat kita ganti keywordnya dari public menjadi private dan kita jalankan
//maka hasilnya akan sama seperti sebelumnya dan tidak terjadi error
//hal ini karena kita hanya menggunakan judul, penulis, penerbit dan harga di class produk saja dan kita tidak pakai diluarnya
    private $judul,
            $penulis,
            $penerbit,
            $harga,
...
$produk1->setpenulis("Winda Kasih"); //untuk menambahkan judulnya
